...
class main_GUI :
    ...
    def SetPostions(self) :
        ...
        self.btn_select_background_color.place(x=180, y=150)
        ...
        self.btn_remove_mark.place(x=100 , y=320)
    ...
    def pdfViewer(self):
        ...
        # self.pdf_viewer().pdf_view(top, pdf_location=self.pdf_path, width=120, height=100).pack()

        self.convert_images_to_pdf()
        os.system(self.pdf_path)

    def convert_pdf_to_images(self):
        images = convert_from_path(self.pdf_path , poppler_path=GuiConnector.pdf2image_path)
        self.images = images
    ...
    def MarkPage(self):
        ...
        #
        # image = self.images[self.page_Number]
        # img = GuiConnect.marking_page(self.convert_from_pillow_image_to_opencv(image))
        #
        # self.MarkedPage = (image , self.page_Number)
        # self.images[self.page_Number] = self.convert_from_opencv_image_to_pillow(img)
        #
